#+TITLE: Kubectl Kubernetes CheatSheet

* Contents
:PROPERTIES:
:TOC:      :include siblings :ignore this :depth 2 :force depth
:END:
:CONTENTS:
...
| Validate yaml file with dry run      | =kubectl create -dry-run=client --validate -f pod-dummy.yaml=                                   |
...
| Reference     | [[https://kubernetes.io/docs/concepts/workloads/controllers/deployment/#pausing-and-resuming-a-deployment][Link: Pausing and Resuming a Deployment]] |
...
| Reference                        | [[https://kubernetes.io/docs/concepts/configuration/secret/][Link: Secrets]]                          |
...
https://jimmysong.io/cheatsheets/kubernetes-tricks

** Useful Links

[[https://www.youtube.com/watch?v=PH-2FfFD2PU][Kubernetes in 5 mins]]

[[https://www.youtube.com/watch?v=DC7NECq3Ghs][Setting up and using a single node Kubernetes cluster]]

[[https://www.youtube.com/watch?v=BDrcUjOczsE][Kubernetes - Local Testing]]

[[https://www.youtube.com/watch?v=R-3dfURb2hA][The Illustrated Children's Guide to Kubernetes]]
